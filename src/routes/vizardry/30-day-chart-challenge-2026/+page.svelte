<script>
  ...
  const dayInfo = {
    ...
    8:  { title: 'Circular',                  intro: '', outro: `This is less of a comparison between cities and more a ranking of how differently we're all doomed.`, source: '', tags: ['environment', 'health'], bg: '#EDF6FD' },
